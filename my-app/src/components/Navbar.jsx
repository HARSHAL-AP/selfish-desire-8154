...
<Flex minWidth='max-content' alignItems='center' gap='2'>
  ...
  <ButtonGroup gap='2' pl="250px">
    <Button color="black" fontSize={17}><Link to="/product">Product</Link></Button>
    <Button color="black" fontSize={17}><Link >Support</Link></Button>
    <Button color="black" fontSize={17}><Link > Blog</Link></Button>
    <Button color="black" fontSize={17}><Link >Forum</Link></Button>
    <Button color="black" fontSize={17}><Link to="/aboute">Aboute</Link></Button>
